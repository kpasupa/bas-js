  ...
  async exec(st) {
    switch (st.t) {
      ...
      case 'gscreen': {
        ...
        // GFX modes with fixed hardware column width: SCREEN 1/7/13 = 40-col, SCREEN 2+ = 80-col.
        // SCREEN 0 (text mode) does NOT change WIDTH — real GW-BASIC preserves the current WIDTH
        // setting when switching back to text mode, so WIDTH 40 stays until WIDTH 80 overrides it.
